...
import { useDeleteConfirmOrderMutation, useGetAllConfirmOrderApiWithoutQueryQuery, useInsertConfirmOrderMutation, useUpdateConfirmOrderMutation } from "../../features/confirmOrder/confirmOrder";
...
const ConfirmOrderTable = () => {
  ...
  const { data, isLoading, isError, error, refetch } =
    useGetAllConfirmOrderApiWithoutQueryQuery(queryArgs);
