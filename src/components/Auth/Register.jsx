        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full mt-1 p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 text-gray-900"
          ...
          {/* Error message */}
          {isError && <p className="text-red-500 text-sm">{error?.data?.message || "Failed to Registration"}</p>}
          ...
          <p className="mt-2 text-center"><span className='text-gray-700'>Already have an account?</span><span><a className="text-blue-600" href="/login"> Sign In</a></span></p>
