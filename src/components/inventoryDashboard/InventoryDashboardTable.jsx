...
//             <select
//               value={category}
//               onChange={(e) => setCategory(e.target.value)} // setCategory ফাংশন দিয়ে filter পরিবর্তন হবে
//               className="h-11 border border-slate-200 rounded-xl px-3 text-slate-900 bg-white outline-none
//              focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-200"
//             >
//               <option value="">All</option>
//               <option value="Received Product">Received Product</option>
//               <option value="Purchase Return Product">
//                 Purchase Return Product
//               </option>
//               <option value="In Transit Product">In Transit Product</option>
//               <option value="Sales Return Product">Sales Return Product</option>
