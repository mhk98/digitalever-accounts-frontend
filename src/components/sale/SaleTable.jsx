        ...
        <div className="flex items-center justify-center">
          <Select
            ...
            value={buyerOptions.find(
              (option) => option.value === currentSale?.supplierId,
          ...
          <tbody className="divide-y divide-gray-700">
            {sales.map((product) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                  {Number(product.rate || 0).toFixed(0)}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                  {Number(product.due_amount).toFixed(2)}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                  {product.remarks}
                </td>
          ...
          >
            ...
            <div className="mt-4">
              ...
              <Select
                ...
                value={productOptions.find(
                  (option) => option.value === currentSale.productId,
                )}
            ...
            <div className="mt-4">
              ...
              <Select
                options={buyerOptions}
                value={buyerOptions.find(
                  (option) => option.value === currentSale.buyerId,
                )}
                onChange={(selectedOption) =>
                  setCurrentSale({
                    ...currentSale,
            ...
            <div className="mt-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setCurrentSale({ ...currentSale, rate: e.target.value })
                }
                className="border border-gray-300 rounded p-2 w-full mt-1 text-black"
              />
            </div>
          ...
          >
            ...
            <div className="mt-4">
              ...
              <Select
                options={productOptions}
                value={productOptions.find(
                  (option) => option.value === createSale.productId,
                )}
                onChange={(selectedOption) =>
                  setCreateSale({
                    ...createSale,
            ...
            <div className="mt-4">
              ...
              <Select
                options={buyerOptions}
                value={buyerOptions.find(
                  (option) => option.value === createSale.buyerId,
                )}
                onChange={(selectedOption) =>
                  setCreateSale({
                    ...createSale,
            ...
            <div className="mt-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setCreateSale({ ...createSale, quantity: e.target.value })
                }
                className="border border-gray-300 rounded p-2 w-full mt-1 text-black"
              />
            </div>
            <div className="mt-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setCreateSale({ ...createSale, rate: e.target.value })
                }
                className="border border-gray-300 rounded p-2 w-full mt-1 text-black"
              />
            </div>
            <div className="mt-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setCreateSale({ ...createSale, paid_amount: e.target.value })
                }
                className="border border-gray-300 rounded p-2 w-full mt-1 text-black"
              />
            </div>
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setCreateSale({ ...createSale, remarks: e.target.value })
                }
                className="border border-gray-300 rounded p-2 w-full mt-1 text-black"
                rows={4} // You can adjust the number of rows as needed
              />
