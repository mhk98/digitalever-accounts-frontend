...
// import { useDeleteReceivedProductMutation, useGetAllReceivedProductQuery, useGetAllReceivedProductWithoutQueryQuery, useInsertReceivedProductMutation, useUpdateReceivedProductMutation } from "../../features/receivedProduct/receivedProduct";
...
//   const [receivedProductsData, setReceivedProductsData] = useState([]);
...
//       setReceivedProductsData(data2.data);
//     }
...
//   const { data, isLoading, isError, error, refetch } = useGetAllReceivedProductQuery(queryArgs);
...
//   const productOptions = receivedProductsData.map((p) => ({
//     value: p.name,
//     label: p.name,
//   }));
